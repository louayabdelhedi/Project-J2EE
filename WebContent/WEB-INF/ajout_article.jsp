...
Logout
          ...
          <div class="title-env">
           <h1 class="title">Ajout Articles</h1>
...
$(this).data('select2').results.addClass('overflow-hidden').perfectScrollbar();
                   ...
                   <form method="post"> 
                   	...
                   	<div class="action-buttons">
                   	 <button type="submit" id="submit" class="btn btn-block btn-secondary">Ajouter</button> 
                   	 <button type="reset" class="btn btn-block btn-gray">Reset</button>
                         ...
                         <div class="member-form-inputs">
                          <div class="row"> 
                          	...
                          	<div class="col-sm-9">
                          	 <input type="text" class="form-control" name="libelleArticle" id="libelleArticle" value=""  /> 
                          	</div> 
                          	</div>
                          	<div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="referenceArticle" id="referenceArticle" value="" />
                          	   </div> 
                          	   </div> 
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="prixHtArticle" id="prixHtArticle" value="" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="tvaArticle" id="tvaArticle" value="" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="quantiteArticle" id="quantiteArticle" value="" />
                          	   </div> 
                          	   </div>
                          	<div class="row">
                          	 <div class="col-sm-3">
