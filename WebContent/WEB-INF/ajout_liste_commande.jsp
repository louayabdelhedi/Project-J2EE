...
Logout
          ...
          <div class="title-env">
           <h1 class="title">Ajout Lignes Commandes</h1>
              ...
              <div class="breadcrumb-env">
               ...
               Home
                 ...
                 <a href="">Commandes</a>
                  ...
                  <li class="active">
                   <strong>Ajout Lignes Commandes</strong> 
                  </li> 
                 </ol>
                  </div>
                   </div>
                   	 ...
                   	 <button type="reset" class="btn btn-block btn-gray">Reset</button>
                         ...
                         <div class="member-form-inputs">
                          <div class="row"> 
                          	...
                          	<div class="col-sm-9">
                          	 <input type="text" class="form-control" name="quantiteCommande" id="quantiteCommande" value=""  /> 
                          	</div> 
                          	</div>
                          	<div class="row">
                          	 <div class="col-sm-3">
