...
Logout
         ...
         <div class="tab-content">
           ...
           <tbody> 
           	<tr>
           	 <td class="user-cb">
           	  <input type="checkbox" class="cbr" name="Clients-list[]" value="1" checked /> 
           	 </td>
           	 <td class="user-id">
           	  <div name="idClient" class="id">1</div> 
          
           	 </td> 
           	 <td class="user-name">
				<div name="nomClient" class="name">Krichen</div><div name="prenomClient" class="name">Bilel</div>
			 </td> 
           	 <td class="hidden-xs hidden-sm">
           	  <div name="adresseClient" class="name">Rue Manzel Chaker Km 3</div>
           	 </td> 
           	 <td class="hidden-xs hidden-sm">
           	  <div name="villeClient" class="name">Sfax - Tunisie</div>
           	 </td>
           	 <td class="user-id">
           	  <div name="cinClient" class="id">08896635</div> 
           	 </td> 
           	 <td class="user-id">
           	  <div name="telClient" class="id">26654993</div>
