...
Logout
          ...
          <div class="title-env">
           <h1 class="title">Liste Des Employées</h1>
              ...
              <div class="breadcrumb-env">
               ...
               Home
                 ...
                 <a href="">Employées</a>
                  ...
                  <li class="active">
                   <strong>Liste Des Employées</strong> 
                  </li> 
                 </ol>
                  </div>
                   </div>
           ...
           <tbody> 
           <%
           List<Bean> emps = ed.listAll() ;
           for(int i=0;i<emps.size();i++){
           %>
           	<tr>
           	 <td class="user-cb">
           	  <input type="checkbox" class="cbr" name="Employees-list[]" value="1" checked /> 
           	 </td> 
           	 <td class="user-name">
				<div name="nomEmploye" class="name"><% out.write(((Employe)emps.get(i)).getNomEmploye()); %></div><div name="prenomEmploye" class="name">Bilel</div>
			 </td> 
           	 <td class="hidden-xs hidden-sm">
           	  <div name="adresseEmploye" class="name"><% out.write(((Employe)emps.get(i)).getAdresseEmploye()); %></div>
           	 </td> 
           	 <td class="user-id">
           	  <div name="cinEmploye" class="id"><% out.write(((Employe)emps.get(i)).getCinEmploye()); %></div> 
           	 </td> 
           	 <td class="user-name">
				<div name="loginEmploye" class="name"><% out.write(((Employe)emps.get(i)).getLoginEmploye()); %></div>
			 </td>

           	 
			 <td class="action-links">
			 <form method="post">
			  <button name="modifier_emp" value="<%out.write(((Employe)emps.get(i)).getLoginEmploye());%>" class="edit" type="submit"> 
			  <i class="linecons-pencil"></i>
				Edit 
			  </button> 
			  <button name="supprimer_emp" value="<%out.write(((Employe)emps.get(i)).getLoginEmploye());%>" class="delete" type="submit"> 
