										     ...
										     <header class="logo-env"> <!-- logo -->
										      <div class="logo">
										       <a href="#" class="logo-expanded">
										        <img src="assets/images/logo%402x.png" width="80" alt="" />
										       </a>
    ...
    <li>
     <a href="#" data-toggle="chat">
      <i class="fa-comments-o">
          ...
          <div class="title-env">
           <h1 class="title">Liste Des Familles Articles</h1>
              ...
              <div class="breadcrumb-env">
               ...
               Home
                 ...
                 <li> 
                 <a href="">Famille Articles</a>
                  </li> 
                  <li class="active">
                   <strong>Liste Des Familles Articles</strong> 
                  </li> 
                 </ol>
                  </div>
                   </div>
         <div class="tab-content">
           ...
           <tbody> 
           	<tr>
           	 <td class="user-cb">
           	  <input type="checkbox" class="cbr" name="Famille-Articles-list[]" value="1" checked /> 
           	 </td>
           	 <td class="user-id">
           	  <div name="idFamille" class="id">1</div> 
