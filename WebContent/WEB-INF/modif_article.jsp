		 ...
		 <link rel="stylesheet" href="assets/css/xenon-core.css" id="style-resource-5">
			<link rel="stylesheet" href="assets/css/xenon-forms.css" id="style-resource-6">
			 <link rel="stylesheet" href="assets/css/xenon-components.css" id="style-resource-7">
				...
				<link rel="stylesheet" href="assets/js/select2/select2.css" id="style-resource-10">
				<link rel="stylesheet" href="assets/js/select2/select2-bootstrap.css" id="style-resource-11"> 
				<link rel="stylesheet" href="assets/js/multiselect/css/multi-select.css" id="style-resource-12">
...
Logout
          ...
          <div class="title-env">
           <h1 class="title">Modifier Articles</h1>
              ...
              <div class="breadcrumb-env">
               ...
               Home
                 ...
                 <a href="">Articles</a>
                  ...
                  <li class="active">
                   <strong>Modifier Articles</strong> 
                  </li> 
                 </ol>
                  </div>
                   </div>
...
{
$("#s2example-1").select2({
placeholder: 'Select Famille Article...',
allowClear: true
...
$(this).data('select2').results.addClass('overflow-hidden').perfectScrollbar();
                   ...
                   <form method="post"> 
                   	...
                   	<div class="action-buttons">
                   	 <button type="submit" id="submit" class="btn btn-block btn-secondary">Modifier</button> 
                   	 <button type="reset" class="btn btn-block btn-gray">Reset</button>
                   	</div>
                   </div>  
                        </div> 
                        </div>
                         <div class="member-form-inputs">
                          <div class="row"> 
                          	<div class="col-sm-3"> 
                          		<label class="control-label" for="libelleArticle" >Libelle</label> 
                          	</div> 
                          	<div class="col-sm-9">
                          	 <input type="text" class="form-control" name="libelleArticle" id="libelleArticle" value="<%out.write();%>"  /> 
                          	</div> 
                          	</div>
                          	<div class="row">
                          	 <div class="col-sm-3">
                          	  <label class="control-label" for="referenceArticle">Reference</label> 
                          	 </div> 
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="referenceArticle" id="referenceArticle" value="<%out.write();%>" />
                          	   </div> 
                          	   </div> 
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	  <label class="control-label" for="prixHtArticle">Prix HTVA</label> 
                          	 </div> 
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="prixHtArticle" id="prixHtArticle" value="<%out.write();%>" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	  <label class="control-label" for="tvaArticle">TVA</label> 
                          	 </div> 
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="tvaArticle" id="tvaArticle" value="<%out.write();%>" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	  <label class="control-label" for="login">Quantité</label> 
                          	 </div> 
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="quantiteArticle" id="quantiteArticle" value="<%out.write();%>" />
                          	   </div> 
                          	   </div>
                          	<div class="row">
                          	 <div class="col-sm-3">
                          	  <label class="control-label" for="nomFamille">Famille Article</label> 
                          	 </div> 
                          	 <div class="col-sm-9">
                          	 <select class="form-control" name="nomFamille" id="s2example-1"> 
                          	  <option></option>
                          	  <option value="<%out.write();%>">PC</option>
                          	 </select>
                          	 </div> 
                          	</div>
