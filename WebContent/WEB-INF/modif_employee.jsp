...
Logout
          ...
          <div class="title-env">
           <h1 class="title">Modifier Employées</h1>
              ...
              <div class="breadcrumb-env">
               ...
               Home
                 ...
                 <a href="">Employées</a>
                  ...
                  <li class="active">
                   <strong>Modifier Employées</strong> 
                  </li> 
                 </ol>
                  </div>
                   </div>
                   <%
	                   Employe employe = (Employe) request.getSession().getAttribute("employe");
	                       ...
	                       Employe emp = (Employe)ed.search(request.getSession().getAttribute("id_emp").toString());
                   %>
                   <form method="post"> 
                   ...
                   </div> <div class="col-md-10 col-sm-8"> <div class="user-img"> <img src="assets/images/user-4.png" class="img-circle" alt="user-pic" /> </div>
                    <div class="user-name">
                     <a href="#">Krichen Bilel</a>
                       </div>
                        </div> 
                         ...
                         <div class="member-form-inputs">
                          <div class="row"> 
                          	...
                          	<div class="col-sm-9">
                          	 <input type="text" class="form-control" name="nomEmploye" id="name" value="<%out.write(emp.getNomEmploye());%>"  /> 
                          	</div> 
                          	</div>
                          	<div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="prenomEmploye" id="prenom" value="<%out.write(emp.getPrenomEmploye());%>" />
                          	   </div> 
                          	   </div> 
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="adresseEmploye" id="adresse" value="<%out.write(emp.getAdresseEmploye());%>" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="cinEmploye" id="cin" value="<%out.write(String.valueOf(emp.getCinEmploye()));%>" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="loginEmploye" id="login" value="<%out.write(emp.getLoginEmploye());%>" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="mpEmploye" id="pwd" value="*************" />
                          	   </div> 
                          	   </div>
