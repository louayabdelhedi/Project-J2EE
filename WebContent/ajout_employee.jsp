...
Logout
          ...
          <div class="title-env">
           <h1 class="title">Ajout Employées</h1>
                     ...
                     <a href="#">Krichen Bilel</a>
                         ...
                         <div class="member-form-inputs">
                          <div class="row"> 
                          	...
                          	<div class="col-sm-9">
                          	 <input type="text" class="form-control" name="nomEmploye" id="name" value=""  /> 
                          	</div> 
                          	</div>
                          	<div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="prenomEmploye" id="prenom" value="" />
                          	   </div> 
                          	   </div> 
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="adresseEmploye" id="adresse" value="" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="cinEmploye" id="cinEmploye" value="" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="loginEmploye" id="loginEmploye" value="" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="mpEmploye" id="mpEmploye" value="" />
                          	   </div> 
                          	   </div>
