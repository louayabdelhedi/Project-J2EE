    ...
    <li>
     <a href="#" data-toggle="chat">
      <i class="fa-comments-o">
          ...
          <div class="title-env">
           <h1 class="title">Liste Des Lignes Commandes</h1>
              ...
              <div class="breadcrumb-env">
               ...
               Home
                 ...
                 <a href="">Commandes</a>
                  ...
                  <li class="active">
                   <strong>Liste Des lignes Commandes</strong> 
                  </li> 
                 </ol>
                  </div>
                   </div>
           ...
           <tbody> 
           	<tr>
           	 <td class="user-cb">
           	  <input type="checkbox" class="cbr" name="Lignes-Commandes-list[]" value="1" checked /> 
           	 </td>
           	 <td class="user-id">
           	  <div name="numLigne" class="id">1</div> 
           	 </td> 
           	 <td class="user-name">
				<div name="quantiteCommande" class="name">120</div>
			 </td> 
           	 <td class="hidden-xs hidden-sm">
           	  <div name="idArticle" class="name">MotherBoard</div>
           	 </td> 
           	 <td class="user-name">
           	  <div name="numCommande" class="name">1</div> 
           	 </td> 
