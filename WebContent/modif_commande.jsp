    ...
    <li>
     <a href="#" data-toggle="chat">
      <i class="fa-comments-o">
          ...
          <div class="title-env">
           <h1 class="title">Modifier Commandes</h1>
              ...
              <div class="breadcrumb-env">
               ...
               Home
                 ...
                 <a href="">Commandes</a>
                  ...
                  <li class="active">
                   <strong>Modifier Commandes</strong> 
                  </li> 
                 </ol>
                  </div>
                   </div>
                   	...
                   	<div class="action-buttons">
                   	 ...
                   	 <button type="reset" class="btn btn-block btn-gray">Reset</button>
                         ...
                         <div class="member-form-inputs">
                          <div class="row"> 
                          	<div class="col-sm-3"> 
                          		<label class="control-label" for="numCommande" >N° Commande</label> 
                          	</div> 
                          	<div class="col-sm-9">
                          	 <input type="text" class="form-control" name="numCommande" id="numCommande" value="<%out.write();%>"  /> 
                          	</div> 
                          	</div>
                          	<div class="row">
                          	 <div class="col-sm-3">
                          	  <label class="control-label" for="dateCommande">Date Commande</label> 
                          	 </div> 
                          	  <div class="col-sm-9"> 
                              <input type="text" name="dateCommande" id="dateCommande" class="form-control datepicker" data-start-view="1">
                              </div>
                          	   </div> 
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	  <label class="control-label" for="dateLivraison">Date Livraison</label> 
                          	 </div> 
                          	  <div class="col-sm-9"> 
                              <input type="text" name="dateLivraison" id="dateLivraison" class="form-control datepicker" data-start-view="1">
                              </div>
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <select class="form-control" name="idClient" id="s2example-1"> 
                              <option></option>
                              <option value="<%out.write();%>" selected>Krichen Bilel</option>
                             </select>
                          	   </div> 
                          	   </div>
          ...
          <script src="assets/js/joinable.js" id="script-resource-4"></script>
           ...
           <script src="assets/js/xenon-toggles.js" id="script-resource-6"></script>
            <!-- JavaScripts initializations and stuff -->
             ...
             <script src="assets/js/bootstrap-datepicker.js" id="script-resource-9"></script>
               </body> 
<!-- Mirrored from themes.laborator.co/xenon/blank/sidebar/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 May 2015 10:24:18 GMT -->
</html>