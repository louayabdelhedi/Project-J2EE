                     ...
                     <a href="#">Krichen Bilel</a>
                         ...
                         <div class="member-form-inputs">
                          <div class="row"> 
                          	...
                          	<div class="col-sm-9">
                          	 <input type="text" class="form-control" name="nomEmploye" id="name" value="<%out.write();%>"  /> 
                          	</div> 
                          	</div>
                          	<div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="prenomEmploye" id="prenom" value="<%out.write();%>" />
                          	   </div> 
                          	   </div> 
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="adresseEmploye" id="adresse" value="<%out.write();%>" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="cinEmploye" id="cin" value="<%out.write();%>" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="loginEmploye" id="login" value="<%out.write();%>" />
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 <div class="col-sm-3">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <input type="text" class="form-control" name="mpEmploye" id="pwd" value="<%out.write();%>" />
                          	   </div> 
                          	   </div>
