...
Logout
          ...
          <div class="title-env">
           <h1 class="title">Modifier Famille Article</h1>
              ...
              <div class="breadcrumb-env">
               ...
               Home
                 ...
                 <li> 
                 <a href="">Familles Articles</a>
                  </li> 
                  <li class="active">
                   <strong>Modifier Famille Article</strong> 
                  </li> 
                 </ol>
                  </div>
                   </div>
                   	...
                   	<div class="action-buttons">
                   	 ...
                   	 <button type="reset" class="btn btn-block btn-gray">Reset</button>
                         ...
                         <div class="member-form-inputs">
                          <div class="row"> 
                          	<div class="col-sm-3"> 
                          		<label class="control-label" for="nomFamille" >Nom Famille</label> 
                          	</div> 
                          	<div class="col-sm-9">
                          	 <input type="text" class="form-control" name="nomFamille" id="nomFamille" value="<%out.write();%>"  /> 
                          	</div> 
                          	</div>
