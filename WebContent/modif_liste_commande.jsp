...
Logout
          ...
          <div class="title-env">
           <h1 class="title">Modifier Lignes Commandes</h1>
              ...
              <div class="breadcrumb-env">
               ...
               Home
                 ...
                 <a href="">Commandes</a>
                  ...
                  <li class="active">
                   <strong>Modifier Lignes Commandes</strong> 
                  </li> 
                 </ol>
                  </div>
                   </div>
                   	...
                   	<div class="action-buttons">
                   	 ...
                   	 <button type="reset" class="btn btn-block btn-gray">Reset</button>
                         ...
                         <div class="member-form-inputs">
                          <div class="row"> 
                          	<div class="col-sm-3"> 
                          		<label class="control-label" for="quantiteCommande" >Quantite Commande</label> 
                          	</div> 
                          	<div class="col-sm-9">
                          	 <input type="text" class="form-control" name="quantiteCommande" id="quantiteCommande" value="<%out.write();%>"  /> 
                          	</div> 
                          	</div>
                          	<div class="row">
                          	 <div class="col-sm-3">
                          	  <label class="control-label" for="idArticle">Article</label> 
                          	 </div> 
                          	 <div class="col-sm-9">
                          	  <select class="form-control" name="idArticle" id="s2example-1"> 
                              <option></option>
                              <option value="<%out.write();%>">MotherBoard</option>
                             </select>
                          	   </div> 
                          	   </div>
                          	   <div class="row">
                          	 ...
                          	 <div class="col-sm-9">
                          	  <select class="form-control" name="numCommande" id="s2example-2"> 
                              <option></option>
                              <option value="<%out.write();%>">1</option>
                             </select>
                          	   </div> 
                          	   </div>
                          	     </div> 
